...
public class VehiclesLeaving extends AppCompatActivity {
    DatabaseReference firebasereference;
    Leaved leaved;
    ImageButton camera2;
    ImageButton image2;
    ImageButton search10;
    EditText vehno8;
    EditText vehname8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicles_leaving);
        ...
        firebase2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(VehiclesLeaving.this,"data inserted successfully",Toast.LENGTH_SHORT).show();
            }
        });
        search10=(ImageButton)findViewById(R.id.search5);
        search10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentsearch=new Intent(VehiclesLeaving.this,Search.class);
        ...
        upload2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mImageUri2!=null){
                    ...
                    Toast.makeText(VehiclesLeaving.this,"select image",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    fileReference2.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(VehiclesLeaving.this, "uploaded successfully", Toast.LENGTH_SHORT).show();
                        }
